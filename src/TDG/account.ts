...
export class TDGAccount {
   ...
   */
  deposit (params: any) {
    return axios.post(this._liteUrl + '/deposit', params)
  }
   ...
   */
  transfer (params: any) {
    return axios.post(this._liteUrl + '/transfer', params)
  }
  ...
  withdrawal (params: any) {
    return axios.post(this._liteUrl + '/withdrawal', params)
  }
  ...
  subAccountSummary (params: IApiSubAccountSummaryRequest) {
    return axios.post(this._liteUrl + '/account_summary', Utils.schemaMap(params, API_SUB_ACCOUNT_SUMMARY_REQUEST_MAP.FULL_TO_LITE)).then(
      (response) => {
  ...
  subAccountHistory (params: any) {
    return axios.get(this._liteUrl + '/account_history', { params })
  }
  ...
  tradeHistory (params: any) {
    return axios.get(this._liteUrl + '/trade_history', { params })
  }
  ...
  transactionHistory (params: any) {
    return axios.get(this._liteUrl + '/transaction_history', { params })
  }
}
