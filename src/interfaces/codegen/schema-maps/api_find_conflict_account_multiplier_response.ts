...
// Schema map for the 'API_FIND_CONFLICT_ACCOUNT_MULTIPLIER_RESPONSE' struct.
export const API_FIND_CONFLICT_ACCOUNT_MULTIPLIER_RESPONSE_MAP: SchemaPairMap = Object.freeze({
  FULL_TO_LITE: {
